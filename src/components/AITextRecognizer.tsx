  ...
  const handleExampleClick = () => {
    ...
    if (toolType === 'textQuote') {
      ...
      examples = [
       ...
       // 整柜报价工具的示例
      examples = [
        "项目：家具出口，柜型：40HQ，起运港：天津港（CNTXG），目的港：芝加哥（USCHI），汇率：7.2，船公司：马士基，海运费：3200美元，国内港杂：3500元，国外关税：500美元，国外拖车费：800美元，国内拖车费：2000元，报价补充：请在7月前安排发货",
        "项目：电子产品，柜型：20GP，起运港：上海港（CNSHG）-目的港：汉堡（DEHAM），汇率：7.1，船公司：地中海航运，海运费：2800美元，国内港杂：3000元，国内拖车费：2200元"
      ];
                ...
                <div className="flex justify-between items-center mt-1">
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {toolType === 'textQuote' 
                      ...
                      ? '提示：AI将自动识别项目、柜型、起运港和目的港（格式：起运港-目的港）、汇率、船公司、海运费、国内外费用等信息，国外港杂固定为700美元'
                ...
                <div className="mt-2">
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    提示：AI将自动识别图片中的{toolType === 'textQuote' 
                      ...
                      : toolType === 'fullContainerQuote'
                      ? '项目、柜型、起运港和目的港、汇率、船公司、海运费、国内外费用等信息'
                      : toolType === 'inquiryOrganizer'
